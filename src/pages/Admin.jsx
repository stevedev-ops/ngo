        ...
        <div className="max-w-[1400px] mx-auto px-4 py-12">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-64 flex flex-col gap-2 shrink-0">
                    {['products', 'categories', 'gallery', 'stories', 'journey', 'team', 'programs', 'settings', 'messages'].map(tab => (
                        <button
                            key={tab}
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {categories.map(cat => (
                    <div key={cat} className="flex justify-between items-center p-3 border rounded-lg dark:border-neutral-700 bg-gray-50 dark:bg-neutral-900">
...
const ProductsEditor = () => {
    ...
    const handleSave = async () => {
        ...
        if (editingId === 'new') {
            savedId = await addProduct(formData);
        } else {
                        ...
                        <div className="col-span-2">
                            ...
                            <div className="mb-2">
                                <ImageUploader
                                    ...
                                    placeholder="Upload new image to append..."
                                />
                            </div>
...
const MessagesViewer = () => {
    ...
    return (
        <div>
            <h2 className="text-xl font-bold mb-6 dark:text-white">Inbox ({messages.length})</h2>
            <div className="space-y-4">
                {messages.map((m, i) => (
                    <div key={i} className="p-4 border rounded-lg bg-white dark:bg-neutral-900 dark:border-neutral-700">
                        ...
                        <div className="text-sm text-primary mb-2">{m.email}</div>
                        <p className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{m.message}</p>
                    </div>
                ))}
            </div>
        </div>
